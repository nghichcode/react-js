    ...
    return (
      <View style={{flex:1}}>
        <View style={{flex: 1,justifyContent: 'center'}}>
          ...
          <Text style={{paddingLeft:20,fontSize: 18,textAlign: 'justify',lineHeight: 30}}>Warehouse Management System</Text>
          <Text style={{paddingLeft:110,fontSize: 18,lineHeight: 70,fontWeight:'bold',color:'#FF33FF'}}>Copyright 2019</Text>
        </View>
