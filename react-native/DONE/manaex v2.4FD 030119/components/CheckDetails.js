  ...
  render() {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={{marginLeft:12,marginBottom:20}}>So BB Kiem Dem: {this.state.code}</Text>
        <TextInput style={{height:40,borderColor:'#196DF9',borderWidth:1,marginLeft:10,marginRight:10,paddingLeft:10}}
