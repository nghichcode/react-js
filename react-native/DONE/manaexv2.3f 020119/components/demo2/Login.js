...
export default class Login extends React.Component{
  constructor(props) {
    super(props);
    this.state={username:'',password:'',res:''};
  }
  ...
  render() {
    ...
    <View style={{flex:1}} >
      ...
      <View style={styles.container}>
        <Text style={{paddingLeft:110,fontSize:20,paddingBottom:50, color:'red'}}>ABC warehouse</Text>
        <View>
...
const styles = StyleSheet.create({
  ...
  view2:{borderBottomWidth:1,borderColor:'purpose',height:25,width:'55%',marginBottom:30,paddingLeft:10}
});